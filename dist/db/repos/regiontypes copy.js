...
// id, name, parent
// schemas
exports.shRegionTypesCreate = Joi.object().keys({
    id: Joi.string().required(),
    name: Joi.string().required(),
    parent: Joi.string().allow(null)
});
exports.shRegionTypesValues = Joi.object().keys({
    id: Joi.string(),
    name: Joi.string(),
    parent: Joi.string()
});
exports.shRegionTypesUpdate = Joi.object().keys({
    ids: Joi.array().items(default_schemas_1.shText).required(),
    values: exports.shRegionTypesValues.required(),
});
const sql = sqlProvider.regiontypes;
class RegionTypesRepository {
    constructor(db, pgp) {
        this.keys = ["id"];
        this.db = db;
        this.pgp = pgp;
    ...
    add(type, values) {
        if (type === "full") {
            return this.db.task("add region type", (t) => this.add("id", values).then((id) => {
                console.log("id:", id);
    ...
    update(type, data) {
        if (type === "full") {
            return this.db.task("update region types", (t) => this.update("fast", data).
                then(() => {
...
exports.RegionTypesRepository = RegionTypesRepository;
//# sourceMappingURL=regiontypes copy.js.map