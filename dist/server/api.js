...
exports.defineRoutes = (app, config) => {
    ...
    // create new filter item
    routes.dbPOST("/filter-items/multiple/:type", (req) => handler_1.multiValidator([handler_1.valid(req.params, default_schemas_1.shDefaultTypeCreate), handler_1.valid(req.body, filteritems_1.shFilterItemsMultipleCreate)]), (db, values) => db.filteritems.add(values[0].type, values[1]));
